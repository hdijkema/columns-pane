...
@defmethod*[([(column-min-width (c column-index) [w or/c dimenstion-integer?]) dimension-integer?])]{
...
@defmethod*[([(column-keep-min-width (c column-index) [k or/c boolean]) boolean?])]{
